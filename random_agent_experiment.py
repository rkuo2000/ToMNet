...
for alpha in species:
    print('\t Randomly sampling species S(a=%0.2f)'%(alpha))
...
construct_time = datetime.now() - start_time
print('Construction completed in %d min %d sec' % (int(construct_time.seconds / 60), int(construct_time.seconds % 60)))

print()
print('>>> ToMNet start learning...')
print()
episodes = []
...
for a in tomnets:
    for epoch in range(num_epochs):
        ...
        print('-'*20)
	# plot learning curve (loss reducing)
...
print()
print('>>> Test random sampling of Random Agents...')
print()
start_time = datetime.now()
